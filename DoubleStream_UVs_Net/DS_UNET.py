...
from U_Net_CPD import U_Net_CPD
...
def trainModel_DS_Net(trainurls,
    ...
    model_hsr = U_Net_CPD(input_shape=(hsrimagesize, hsrimagesize, hsrchannel), n_class=nb_class)
    ...
    V3P_hsr_mid = model_hsr.get_layer("U_Net_CPD_HSR").output
    ...
    logs_dir = "./logsfile"
    model_name = "DS_UNET_PSP_sz_" + str(monte_run_count) + ".h5"
    loss_name = "DS_UNET_PSP_sz_" + str(monte_run_count) + ".csv"
