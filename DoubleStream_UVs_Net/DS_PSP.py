...
def trainModel_DS_Net(trainurls,
    ...
    V3P_hsr_mid = model_hsr.get_layer("upsam_psp_hsr").output
    ...
    logs_dir = "./logsfile"
    model_name = "DS_PSP_PSP_sz_" + str(monte_run_count) + ".h5"
    loss_name = "DS_PSP_PSP_sz_" + str(monte_run_count) + ".csv"
