...
from DeepLabv3p import Deeplab_v3p_hsr
...
def trainModel_DS_Net(trainurls,
    ...
    model_hsr = Deeplab_v3p_hsr(input_shape=(hsrimagesize, hsrimagesize, hsrchannel), n_class=nb_class,
                                encoder_name="xception_41", encoder_weights=None, weight_decay=weight_decay,
    ...
    V3P_hsr_mid = model_hsr.get_layer("upsam_v3p_hsr").output
    ...
    logs_dir = "./logsfile"
    model_name = "DS_V3P_PSP_sz_" + str(monte_run_count) + ".h5"
    loss_name = "DS_V3P_PSP_sz_" + str(monte_run_count) + ".csv"
